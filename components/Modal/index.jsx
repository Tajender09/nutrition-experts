...
const CouponModal = ({
  ...
  const handleCloseModal = (e) => {
    if (e.target.id === "backdrop") setShowCouponModal(false);
  };
  ...
  return showCouponModal ? (
    ...
    >
      <div className="w-full h-full md:h-3/4 md:w-1/2 bg-white rounded-md relative">
        ...
        <div className="mt-4 w-full bg-dim_grey"></div>
